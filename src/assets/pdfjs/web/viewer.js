  ...
  var PDFViewerApplication = {
    ...
    download: function download() {
      ...
      function checkNativeApp() {
        var insidenative = readCookie("insidenative");
        return (!(insidenative == undefined || insidenative == false)) || (insidenative == "true");
      }
      function nativeFileHandling(blob, type, fileName) {
        ...
        reader.onloadend = function () {
            ...
            var argsNative = { mimeType: mimeType, decodedFile: decodedFile, filename: fileName, type: type };
            window.parent.flutter_inappwebview.callHandler('getFileBlob', ...[argsNative]);
        };
      }
      /******************** ADDED BY KAREPERT  ********/
      ...
      this.pdfDocument.getData().then(function (data) {
        ...
        /******************** ADDED BY KAREPERT  ********/
        if(checkNativeApp()){
          nativeFileHandling(blob,'application/pdf',filename);
        }else{
